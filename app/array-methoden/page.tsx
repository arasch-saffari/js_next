...
export default function page() {
  return (
    <div>
      <h1 className="mb-8 text-3xl font-bold">Array-Methoden in JavaScript</h1>
...
const quadrate: number[] = zahlen.map((zahl) => zahl * zahl);
console.log(quadrate);`}
      ...
      <div className="p-6 mb-8 bg-white rounded-lg shadow">
        ...
        <pre className="p-4 mb-4 text-sm bg-gray-100 rounded">
          <code>
            {`const zahlen: number[] = [1, 2, 3, 4, 5];
const geradeZahlen: number[] = zahlen.filter((zahl) => zahl % 2 === 0);
console.log(geradeZahlen);`}
          </code>
        </pre>
        <p>
          Ergebnis: <span className="p-1 bg-green-200 rounded">[2, 4]</span>
        </p>
      </div>
      ...
      <div className="p-6 mb-8 bg-white rounded-lg shadow">
        ...
        <pre className="p-4 mb-4 text-sm bg-gray-100 rounded">
          <code>
            {`const zahlen: number[] = [1, 2, 3, 4, 5];
const summe: number = zahlen.reduce((akkumulator, zahl) => akkumulator + zahl, 0);
console.log(summe);`}
          </code>
        </pre>
        <p>
          Ergebnis: <span className="p-1 bg-green-200 rounded">15</span>
        </p>
      </div>
      ...
      <div className="p-6 mb-8 bg-white rounded-lg shadow">
        ...
        <pre className="p-4 mb-4 text-sm bg-gray-100 rounded">
          <code>
            {`const zahlen: number[] = [1, 2, 3, 4, 5];
const ersteUngeradeZahl: number | undefined = zahlen.find((zahl) => zahl % 2 === 1);
console.log(ersteUngeradeZahl);`}
          </code>
        </pre>
        <p>
          Ergebnis: <span className="p-1 bg-green-200 rounded">1</span>
        </p>
      </div>
      ...
      <div className="p-6 mb-8 bg-white rounded-lg shadow">
        ...
        <pre className="p-4 mb-4 text-sm bg-gray-100 rounded">
          <code>
            {`const zahlen: number[] = [1, 2, 3, 4, 5];
const hatUngeradeZahl: boolean = zahlen.some((zahl) => zahl % 2 === 1);
console.log(hatUngeradeZahl);`}
      ...
      <div className="p-6 mb-8 bg-white rounded-lg shadow">
        ...
        <pre className="p-4 mb-4 text-sm bg-gray-100 rounded">
          <code>
            {`const zahlen: number[] = [1, 2, 3, 4, 5];
const sindAlleZahlenUngerade: boolean = zahlen.every((zahl) => zahl % 2 === 1);
console.log(sindAlleZahlenUngerade);`}
          </code>
        </pre>
        <p>
          Ergebnis: <span className="p-1 bg-green-200 rounded">false</span>
        </p>
      </div>
    </div>
  );
